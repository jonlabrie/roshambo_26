...
⚠ **THE MARKS THEMSELVES ARE LAW — read [[visual-identity]] BEFORE generating any art that
represents a game concept.** This section is how the glyph images are RASTERISED; that page is
what they are and where they may not be redrawn. A session invented literal rock/paper/scissors
sprites for a firework while the approved glyphs sat in the repo, rendered on every throw button.
